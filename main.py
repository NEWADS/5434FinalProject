...
if __name__ == '__main__':
    ...
    x_train_1, y_train_1 = sklearn.utils.shuffle(x_train_1, y_train_1, random_state=18)
    x_train_1, y_train_1 = x_train_1[:(19713*3), :], y_train_1[:(19713*3)]
    x_train_2, y_train_2 = x_train[np.where(y_train == 2)[0]], y_train[np.where(y_train == 2)[0]]
    # randomly sample some data to make the dataset looks more equally distributed.
    x_train_2, y_train_2 = sklearn.utils.shuffle(x_train_2, y_train_2, random_state=18)
    x_train_2, y_train_2 = x_train_2[:(19713), :], y_train_2[:(19713)]
    ...
    # cf = RandomForestClassifier(random_state=114, n_jobs=4, verbose=10, n_estimators=500,
    ...
    df.to_csv('./output_ann_lite_batch_40960.csv', index=False)
